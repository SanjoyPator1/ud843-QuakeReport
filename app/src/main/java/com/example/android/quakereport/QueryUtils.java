...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject baseJsonResponse = new JSONObject(SAMPLE_JSON_RESPONSE); //root
            ...
            for(int i = 0; i< earthquakeArray.length(); i++){
                ...
                //earthquakes - name of the arrayList of earthquake type
                //earthquake object of class Earthquake
